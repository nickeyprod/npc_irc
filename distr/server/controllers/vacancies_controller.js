...
class VacanciesController {
    ...
    async processVacanciesRequest(req) {
    ...
    async processVacanciesIdRequest(req) {
        if (!req.params.id) {
    ...
    async processVacanciesCreateRequest(req) {
    ...
    async processVacanciesUpdateRequest(req) {
    ...
    async processVacanciesRemoveRequest(req) {
