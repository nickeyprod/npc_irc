...
class Vacancy extends MainModel {
    ...
    static async createNew(is_opened: boolean, name: string, salary: number, opened_at: Date | undefined, closed_at: Date | undefined = undefined)  {
        const newVacancy = await sq.query(
    ...
    static async updateSpecific(id: number, is_opened: boolean | undefined, name: string | undefined, salary: number | undefined, opened_at: Date | undefined, closed_at: Date | undefined) {
